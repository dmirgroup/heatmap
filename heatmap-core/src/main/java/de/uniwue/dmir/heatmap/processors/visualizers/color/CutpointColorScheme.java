...
public class CutpointColorScheme implements IColorScheme {
	...
	public CutpointColorScheme(Double[] cutpoints, Color[] colors, boolean equals) {
		this.colorMapper = new CutpointMapper<Double, Color>(
				cutpoints,
				colors,
				equals);
	}
	...
	public int getColor(double value) {
		return this.colorMapper.map(value).getRGB();
	}
