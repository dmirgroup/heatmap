...
public class GenericRelativeCoordinatesProvider<TData> 
extends BasicRelativeCoordinatesProvider {
	...
	public GenericRelativeCoordinatesProvider(int x, int y, TData data) {
		super(x, y);
		this.data = data;
	}
